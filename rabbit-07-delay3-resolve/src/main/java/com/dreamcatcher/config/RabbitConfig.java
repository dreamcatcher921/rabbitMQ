...
public class RabbitConfig {
     ...
     * @param queueOrderName
     * @return
     */
    @Bean
    public Binding bindingOrderNormal(DirectExchange directExchange, Queue queueOrderName) {
        return BindingBuilder.bind(queueOrderName).to(directExchange).with("order");
    }

    @Bean
    public Queue queuePayName() {
    ...
    @Bean
    public Binding bindingPayNormal(DirectExchange directExchange, Queue queuePayName) {
        return BindingBuilder.bind(queuePayName).to(directExchange).with("pay");
    }
